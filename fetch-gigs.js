...
const EXCLUDED_KEYWORDS = [
  ...
  // Self-promotion ads ("I'm available for work!") get miscategorized
  // as job openings since they share vocabulary with real postings.
  // A real gig says "we need someone" — these say "pick me."
  "hire me", "available for hire", "for hire!", "open for commission",
  "commissions open", "taking commissions", "commissions are open",
  "check out my portfolio", "i am available for", "i'm available for",
  "dm me for commissions", "self promo", "self-promo",
];
